 ...
 * <p>该类加载一个 DOM 文档并将 BeanDefinitionDocumentReader 应用到它。
 * 文档阅读器将使用给定的 bean 工厂注册每个 bean 定义，
 * 与后者的 {@link org.springframework.beans.factory.support.BeanDefinitionRegistry}
 * 接口的实现交谈。
 * <br/><br/>
 *
